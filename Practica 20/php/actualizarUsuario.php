<?php
	...
	if(!isset($_FILE))
		die("Variable global inexistente");
	...
	$query = "UPDATE usuarios SET nombre='$nombre', direccion='$direccion', sexo='$sexo', telefono='$tel', fecha='$fecha' WHERE idusuario=$iduser";
	...
	echo ("Se ha realizado la actualizacion de sus datos de manera exitosa. Gracias por estar con nosotros " . $array["nick"]);
?>